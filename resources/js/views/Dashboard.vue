<template>
    <PageComponent title="Dashboard">
        ...
        >
            <div
                class="bg-white animate-fade-in-down shadow-md p-3 text-center flex flex-col order-1 lg:order-2"
            ...
            <div
                class="bg-white animate-fade-in-down shadow-md p-3 text-center flex flex-col order-2 lg:order-4"
            ...
            >
                ...
                <div class="flex justify-between">
                    ...
                    <button
                        class="flex py-2 px-4 border border-transparent text-sm roudned-md text-indigo-500 hover:bg-indigo-700 hover:text-white transition-colors focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
                    >
                        <svg
                            xmlns="http://www.w3.org/2000/svg"
                            class="h-6 w-6"
            ...
            <div
                class="bg-white animate-fade-in-down shadow-md p-3 row-span-2 order-4 lg:order-3"
                style="animation-delay: 0.3s"
            >
