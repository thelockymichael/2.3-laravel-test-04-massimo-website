 ...
 *
 *         //If Airport code not found, then NULL is returned
 *
 *
 */
class Airport
{
	...
	/**
	 * Convert IATA Airport Code to Airport Name
	 *
	 * @param string     $code    The 3 letter IATA Airport code
	 *
	 * @return string|null        The airport name or null if not found
	 */
	static function code($code = '')
	{
		if (isset(Airport::$_list[$code])) {
			return Airport::$_list[$code];
		}
	}
}